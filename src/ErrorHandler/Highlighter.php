...
//https://github.com/php-parallel-lint/PHP-Console-Highlighter/blob/master/src/Highlighter.php

/**
 * @author nunomaduro
 * @see https://github.com/nunomaduro/collision/blob/stable/src/Highlighter.php
 */
final class Highlighter
{
    ...
    private const THEME = [
        ...
        self::TOKEN_KEYWORD => ['yellow', 'dark'],
    ...
    private function tokenize($source): array
    {
        ...
        // TODO : améliorer le code : https://github.com/spiral/framework/blob/b38236cd818e2ae4109fa8e5f4f46a71c09aef3b/src/Exceptions/src/Style/ConsoleStyle.php#L30
