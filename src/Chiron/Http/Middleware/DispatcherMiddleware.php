...
class DispatcherMiddleware implements MiddlewareInterface
{
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        if ($routeResult && ! $routeResult->isFailure()) {
            ...
            // set the params before executing the route. Use the default value if necessary.
            $params = $this->mergeDefaults($routeResult->getMatchedParams(), $route->getDefaults());
            $route->setVars($params);
            // get a list of all the middleware (from the Route and from the RouteGroup).
            $middlewares = $this->gatherMiddlewares($route);

            $this->pipeline->pipe($middlewares);
