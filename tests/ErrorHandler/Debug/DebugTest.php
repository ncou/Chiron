...
class DebugTest extends TestCase
{
    ...
    public function testCallErrorExceptionInfo()
    {
        try {
            ...
            $this->assertStringStartsWith('Chiron\ErrorHandler\{closure', $trace[0]['function']);
    ...
    {
        $this->assertSame('', Debug::getLastError());

        ini_set('html_errors', '1');
        @constant('"');
        $this->assertSame('Couldn\'t find constant "', Debug::getLastError());
        ...
        ini_set('html_errors', '1');
        @fopen('nonexist', 'r');
        $this->assertSame('failed to open stream: No such file or directory', Debug::getLastError());
